...
PB_BIND(CarServer_ClosuresState, CarServer_ClosuresState, 4)
...
PB_BIND(CarServer_ChargeScheduleState, CarServer_ChargeScheduleState, 4)


PB_BIND(CarServer_PreconditioningScheduleState, CarServer_PreconditioningScheduleState, 4)
