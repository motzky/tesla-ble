...
typedef struct _CarServer_ResultReason {
    ...
    union _CarServer_ResultReason_reason {
...
typedef struct _CarServer_ChargingStartStopAction {
    ...
    union _CarServer_ChargingStartStopAction_charging_action {
...
typedef struct _CarServer_HvacSeatHeaterActions_HvacSeatHeaterAction {
    ...
    union _CarServer_HvacSeatHeaterActions_HvacSeatHeaterAction_seat_heater_level {
    ...
    union _CarServer_HvacSeatHeaterActions_HvacSeatHeaterAction_seat_position {
...
typedef struct _CarServer_HvacTemperatureAdjustmentAction_Temperature {
    ...
    union _CarServer_HvacTemperatureAdjustmentAction_Temperature_type {
...
typedef struct _CarServer_HvacTemperatureAdjustmentAction_HvacTemperatureZone {
    pb_size_t which_type;
    union _CarServer_HvacTemperatureAdjustmentAction_HvacTemperatureZone_type {
...
typedef struct _CarServer_MediaUpdateVolume {
    ...
    union _CarServer_MediaUpdateVolume_media_volume {
...
typedef struct _CarServer_VehicleControlSunroofOpenCloseAction {
    ...
    union _CarServer_VehicleControlSunroofOpenCloseAction_sunroof_level {
        int32_t absolute_level;
        int32_t delta_level;
    } sunroof_level;
    pb_size_t which_action;
    union _CarServer_VehicleControlSunroofOpenCloseAction_action {
        CarServer_Void vent;
...
typedef struct _CarServer_VehicleControlWindowAction {
    pb_size_t which_action;
    union _CarServer_VehicleControlWindowAction_action {
        CarServer_Void unknown;
        CarServer_Void vent;
        CarServer_Void close;
    } action;
...
typedef struct _CarServer_Ping {
    int32_t ping_id;
    bool has_local_timestamp;
    google_protobuf_Timestamp local_timestamp;
    bool has_last_remote_timestamp;
    google_protobuf_Timestamp last_remote_timestamp;
} CarServer_Ping;
...
typedef struct _CarServer_Response {
    ...
    union _CarServer_Response_response_msg {
...
typedef struct _CarServer_VehicleAction {
    ...
    union _CarServer_VehicleAction_vehicle_action_msg {
...
typedef struct _CarServer_Action {
    ...
    union _CarServer_Action_action_msg {
...
#define CarServer_NearbyChargingSites_init_default {false, google_protobuf_Timestamp_init_default, {{NULL}, NULL}, 0}
...
#define CarServer_Ping_init_default              {0, false, google_protobuf_Timestamp_init_default, false, google_protobuf_Timestamp_init_default}
...
#define CarServer_NearbyChargingSites_init_zero  {false, google_protobuf_Timestamp_init_zero, {{NULL}, NULL}, 0}
...
#define CarServer_Ping_init_zero                 {0, false, google_protobuf_Timestamp_init_zero, false, google_protobuf_Timestamp_init_zero}
...
#define CarServer_NearbyChargingSites_timestamp_tag 1
...
#define CarServer_Ping_local_timestamp_tag       2
#define CarServer_Ping_last_remote_timestamp_tag 3
...
#define CarServer_NearbyChargingSites_timestamp_MSGTYPE google_protobuf_Timestamp
...
X(a, STATIC,   OPTIONAL, MESSAGE,  local_timestamp,   2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  last_remote_timestamp,   3)
#define CarServer_Ping_CALLBACK NULL
#define CarServer_Ping_DEFAULT NULL
#define CarServer_Ping_local_timestamp_MSGTYPE google_protobuf_Timestamp
#define CarServer_Ping_last_remote_timestamp_MSGTYPE google_protobuf_Timestamp
...
#define CARSERVER_CAR_SERVER_PB_H_MAX_SIZE       CarServer_Ping_size
