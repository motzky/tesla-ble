...
typedef struct _Signatures_KeyIdentity {
    ...
    union _Signatures_KeyIdentity_identity_type {
...
typedef struct _Signatures_SignatureData {
    ...
    union _Signatures_SignatureData_sig_type {
...
#define Signatures_KeyIdentity_init_default      {0, {{{NULL}, NULL}}}
#define Signatures_AES_GCM_Personalized_Signature_Data_init_default {{{NULL}, NULL}, {{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
#define Signatures_AES_GCM_Response_Signature_Data_init_default {{{NULL}, NULL}, 0, {{NULL}, NULL}}
#define Signatures_HMAC_Signature_Data_init_default {{{NULL}, NULL}}
#define Signatures_HMAC_Personalized_Signature_Data_init_default {{{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
...
#define Signatures_SessionInfo_init_default      {0, {{NULL}, NULL}, {{NULL}, NULL}, 0, _Signatures_Session_Info_Status_MIN, 0}
#define Signatures_KeyIdentity_init_zero         {0, {{{NULL}, NULL}}}
#define Signatures_AES_GCM_Personalized_Signature_Data_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
#define Signatures_AES_GCM_Response_Signature_Data_init_zero {{{NULL}, NULL}, 0, {{NULL}, NULL}}
#define Signatures_HMAC_Signature_Data_init_zero {{{NULL}, NULL}}
#define Signatures_HMAC_Personalized_Signature_Data_init_zero {{{NULL}, NULL}, 0, 0, {{NULL}, NULL}}
...
#define Signatures_SessionInfo_init_zero         {0, {{NULL}, NULL}, {{NULL}, NULL}, 0, _Signatures_Session_Info_Status_MIN, 0}
...
X(a, CALLBACK, ONEOF,    BYTES,    (identity_type,public_key,identity_type.public_key),   1) \
X(a, STATIC,   ONEOF,    UINT32,   (identity_type,handle,identity_type.handle),   3)
#define Signatures_KeyIdentity_CALLBACK pb_default_field_callback
#define Signatures_KeyIdentity_DEFAULT NULL

#define Signatures_AES_GCM_Personalized_Signature_Data_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, BYTES,    epoch,             1) \
X(a, CALLBACK, SINGULAR, BYTES,    nonce,             2) \
X(a, STATIC,   SINGULAR, UINT32,   counter,           3) \
X(a, STATIC,   SINGULAR, FIXED32,  expires_at,        4) \
X(a, CALLBACK, SINGULAR, BYTES,    tag,               5)
#define Signatures_AES_GCM_Personalized_Signature_Data_CALLBACK pb_default_field_callback
...
#define Signatures_AES_GCM_Response_Signature_Data_CALLBACK pb_default_field_callback
#define Signatures_AES_GCM_Response_Signature_Data_DEFAULT NULL

#define Signatures_HMAC_Signature_Data_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, BYTES,    tag,               1)
#define Signatures_HMAC_Signature_Data_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, BYTES,    tag,               4)
#define Signatures_HMAC_Personalized_Signature_Data_CALLBACK pb_default_field_callback
...
#define Signatures_SessionInfo_CALLBACK pb_default_field_callback
...
/* Signatures_KeyIdentity_size depends on runtime parameters */
/* Signatures_AES_GCM_Personalized_Signature_Data_size depends on runtime parameters */
/* Signatures_AES_GCM_Response_Signature_Data_size depends on runtime parameters */
/* Signatures_HMAC_Signature_Data_size depends on runtime parameters */
/* Signatures_HMAC_Personalized_Signature_Data_size depends on runtime parameters */
/* Signatures_SignatureData_size depends on runtime parameters */
/* Signatures_GetSessionInfoRequest_size depends on runtime parameters */
/* Signatures_SessionInfo_size depends on runtime parameters */
