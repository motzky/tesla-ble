...
typedef struct _CarServer_ChargePortLatchState {
    ...
    union _CarServer_ChargePortLatchState_type {
        CarServer_Void SNA;
...
typedef struct _CarServer_PreconditioningTimes {
    ...
    union _CarServer_PreconditioningTimes_times {
...
typedef struct _CarServer_OffPeakChargingTimes {
    pb_size_t which_times;
    union _CarServer_OffPeakChargingTimes_times {
        CarServer_Void all_week;
        CarServer_Void weekdays;
    } times;
...
#define _CarServer_MediaPlaybackStatus_ARRAYSIZE ((CarServer_MediaPlaybackStatus)(CarServer_MediaPlaybackStatus_Paused+1))
