...
typedef struct _UniversalMessage_Destination {
    ...
    union _UniversalMessage_Destination_sub_destination {
        UniversalMessage_Domain domain;
        pb_callback_t routing_address;
    } sub_destination;
...
#define UniversalMessage_SessionInfoRequest_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
#define UniversalMessage_RoutableMessage_init_default {false, UniversalMessage_Destination_init_default, false, UniversalMessage_Destination_init_default, 0, {{{NULL}, NULL}}, false, UniversalMessage_MessageStatus_init_default, 0, {Signatures_SignatureData_init_default}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
#define UniversalMessage_SessionInfoRequest_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
#define UniversalMessage_RoutableMessage_init_zero {false, UniversalMessage_Destination_init_zero, false, UniversalMessage_Destination_init_zero, 0, {{{NULL}, NULL}}, false, UniversalMessage_MessageStatus_init_zero, 0, {Signatures_SignatureData_init_zero}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
...
X(a, CALLBACK, ONEOF,    BYTES,    (sub_destination,routing_address,sub_destination.routing_address),   2)
#define UniversalMessage_Destination_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, BYTES,    challenge,         2)
#define UniversalMessage_SessionInfoRequest_CALLBACK pb_default_field_callback
...
X(a, CALLBACK, ONEOF,    BYTES,    (payload,protobuf_message_as_bytes,payload.protobuf_message_as_bytes),  10) \
...
X(a, CALLBACK, ONEOF,    BYTES,    (payload,session_info,payload.session_info),  15) \
X(a, CALLBACK, SINGULAR, BYTES,    request_uuid,     50) \
X(a, CALLBACK, SINGULAR, BYTES,    uuid,             51) \
X(a, STATIC,   SINGULAR, UINT32,   flags,            52)
#define UniversalMessage_RoutableMessage_CALLBACK pb_default_field_callback
...
#endif
/* UniversalMessage_Destination_size depends on runtime parameters */
/* UniversalMessage_SessionInfoRequest_size depends on runtime parameters */
/* UniversalMessage_RoutableMessage_size depends on runtime parameters */
#define UNIVERSALMESSAGE_UNIVERSAL_MESSAGE_PB_H_MAX_SIZE UniversalMessage_MessageStatus_size
